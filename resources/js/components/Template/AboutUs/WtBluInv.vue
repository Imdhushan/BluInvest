...
<div class="container">
  <div class="row justify-content-center text-left">
    <div class="col-lg-9 col-xl-8 col-xxl-7">
      <h1 class="fs-2 fs-sm-4 fs-md-5">What is BluInvest</h1>
      <p class="lead">

        Realizing the untapped potential of maximizing the ocean and its assets, the
Government of Sri Lanka has launched BluInvest, a virtual Geographic Information
System (GIS) based Blue Investment Opportunity Map (BIOM) tool to access rapid
data on coastal and EEZ areas. This tool directs investors in identifying the most
investor friendly locations for tourism, energy, boat building, conservation-based
investments and other marine industries in Sri Lanka.

        </p>
        <p class="lead">
            The tool provides investors an opportunity to swiftly access advanced GIS based maps
for areas of interest, derived based on data collected and cross tabulated from several
marine industries and sectors. The value of this tool is that it reduces investors’ time
spent on location identification and eventually help expedite the environmental impact
assessment stage.
        </p>
        <p class="lead">
            With the technical assistance of the United Nations Development Programme in Sri
Lanka, the External Resources Department and the National Planning Department in
consultation with relevant Ministries and Departments, are leading the development and
continuous monitoring of this tool.
        </p>

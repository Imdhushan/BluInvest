    ...
    <div class="container">
      <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
        <div class="col-md-12 col-lg-12 col-xl-8 pb-7 pb-xl-9 text-center text-lg-start">
          <!-- <h1 class="fs-2 fs-sm-4 fs-md-5 text-white "></h1>
  ...
  <div class="row justify-content-center text-justify" >
    <div class="col-lg-10 col-xl-9 col-xxl-8">
      ...
      <p class="lead">
        ...
        Discover Sri Lanka’s rich marine potential through our advanced Blue Investment Opportunity Map (BIOM), a GIS-based tool that opens doors to high-growth opportunities across coastal and Exclusive Economic Zones (EEZ). Whether it’s tourism, energy, boat building, 
        or conservation, this tool is designed to help you locate the most investor-friendly spots for your next successful venture.

    ...
    <section :key="componentKey" class="bg-dark pt-6 pb-4 light" style="background-color: #2196F3" >
        ...
        <div class="container">
            <div class="row flex-center">
                ...
                <h5 class="text-white fw-light" v-else-if="currentStep === 2">Water</h5>
...
const SecurityCards = ref([
  { text: "Security & Life Saving ", dynamicInputs: [ { type: "checkbox", label: "Locations of Police Marine Units", value: false }, { type: "checkbox", label: "Locations of Tourist Police Units", value: false }, { type: "checkbox", label: "Police Life Saving Units ", value: false } ] }
]);

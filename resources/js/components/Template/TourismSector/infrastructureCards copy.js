...
const infrastructureSectionsData = [
  {
    ...
    cards: [
    { text: "Proximity to the main road ", dynamicInputs: [ { type: "checkbox", label: "0m - 200m", value: false,attribute: 'Main_road' }, { type: "checkbox", label: "200m - 400m", value: false }, { type: "checkbox", label: "400m - 600m", value: false }, { type: "checkbox", label: "600m - 800m", value: false } ] },

    { text: "Proximity to secondary roads", dynamicInputs: [ { type: "checkbox", label: "0m - 200m", value: false ,attribute: 'Se_raod' }, { type: "checkbox", label: "200m - 400m", value: false }, { type: "checkbox", label: "400m - 600m", value: false }, { type: "checkbox", label: "600m - 800m", value: false } ] },
  ...
  },
  {
    ...
    cards: [
    { text: " ", dynamicInputs: [ { type: "checkbox", label: "Classified Hotels( 1-5 Star)", value: false,attribute: 'Sta_Hot' }, { type: "checkbox", label: "Tourist Hotels", value: false ,attribute: 'Tou_hot'}, { type: "checkbox", label: "Boutique Hotels & Villas", value: false,attribute: 'Bou_hot'}, { type: "checkbox", label: "Guest Houses", value: false,attribute: 'Gue_hou' }, { type: "checkbox", label: "Bungalows", value: false,attribute: 'Bangalo' }, 
  ...
  },
  {
    ...
    cards: [
    { text: " ", dynamicInputs: [ { type: "checkbox", label: "Locations of Police Marine Units", value: false },
       { type: "checkbox", label: "Locations of Tourist Police Units", value: false },
        { type: "checkbox", label: "Police Life Saving Units ", value: false }
       ] }
    ],
  },
  {
